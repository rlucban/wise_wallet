...
export default function NotificationsScreen() {
  ...
  const renderItem = useCallback(
    ({ item }: { item: Due }) => {
      ...
      const isDueToday = !Number.isNaN(dueDate.getTime()) && isToday(dueDate);

      const DUE_TODAY_BG = "#FEF2F2";
      const DUE_TODAY_BORDER = "#EF4444";
      const DUE_TODAY_BADGE = "#DC2626";
      const DUE_TODAY_TEXT = "#EF4444";
      ...
      return (
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          style={{
            backgroundColor: isDueToday ? DUE_TODAY_BG : theme.colors.surface,
            borderRadius: 16,
            padding: 16,
            marginBottom: 12,
            marginHorizontal: 16,
            flexDirection: "row",
            alignItems: "center",
            borderLeftWidth: isDueToday ? 4 : 0,
            borderLeftColor: isDueToday ? DUE_TODAY_BORDER : undefined,
            ...Platform.select({
        ...
        >
          <View
            style={{
              ...
              height: 48,
              borderRadius: 12,
              backgroundColor: isDueToday ? DUE_TODAY_BADGE : badge.color,
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text
              variant="bodySmall"
              style={{
                color: isDueToday ? DUE_TODAY_TEXT : theme.colors.outline,
          ...
          {isDueToday && (
            <View
              style={{
                ...
                height: 8,
                borderRadius: 4,
                backgroundColor: DUE_TODAY_BORDER,
                marginLeft: 12,
              }}
            />
          )}
